...
### 1.2. U.S. Embassy & Consulates Monitoring Data
...
### 1.3. Estimated PM<sub>2.5</sub> from Combining Satellite Data and Chemical Transport Modeling
...
### 1.4. SO<sub>2</sub> Satellite Data
...
### 4.1. Environmental Survey and Reporting [(ESR)](http://hbk.cei.cn/aspx/default.aspx)  
...
### 4.2. Continuous Emissions Monitoring Systems (CEMS) Data
...
- 5.4.1. [ECMWF Integrated Forecasting System (IFS)](https://www.ecmwf.int/en/forecasts/dataset/operational-archive)
    - **Resolution**: Different models and products have different resolutions: e.g., for the Atmospheric model Ensemble 15-day forecast (Set III - ENS): 0.1° x 0.1°, 4 forecast runs per day (00/06/12/18); different forecast time stamp for different runs (00/06/12/18): hourly, 3-hourly, 6-hourly. Detailed descriptions for different models are available [here](https://confluence.ecmwf.int/display/FUG/Section+2+The+ECMWF+Integrated+Forecasting+System+-+IFS) for detailed descriptions for different models.
    - Access: need a subscription (€3000 (EUR) per annum). Real-time forecast data are available to the public free of charge.

- 5.4.2 [NOAA Global Forecast System (GFS)](https://www.ncei.noaa.gov/products/weather-climate-models/global-forecast)
...
### 6.3. MODIS/Aqua+Terra Global Flood Product
